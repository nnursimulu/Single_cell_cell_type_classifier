...
#SBATCH --job-name=SVM_not_balanced

# Runs cross-validation for not balanced SVM.
module load conda3
...
RESULTS_FILE=${MAIN_PROJECT}/results/CV_SVM_not_balanced_HPC.out # Where the results will be written
WORKDIR=${MAIN_PROJECT}/scripts/classifiers # Directory containing this script.
SUMMARIZED_RESULTS=${MAIN_PROJECT}/results/CV_SVM_not_balanced_averaged.out # Where the averaged results will be written
